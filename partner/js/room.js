$(document).ready(function () {
  ...
  $('#ldg_pop_cancel').on('click', function () {
    ...
    $('#ldg_mainimg_input').val('');
    $('#ldg_subimg_input').val('');
    $('#ldg_pop_info_txt').val('');
    $('#ldg_pop_main_img').attr('src', '');
  });

  $('#info_save_btn').on('click', function () {
    if (!$('#ldg_mainimg_input').val()) {
      alert('대표사진을 등록해주세요');
    } else {
  ...
  $('#room_save_btn').on('click', function(){
    $('.room_modal_bg').hide();
    $('body').removeClass('scrollLock');
  });
  ...
  $('#room_pop_cancel').on('click', function () {
    ...
    $('body').removeClass('scrollLock');
    $('#room_pop input').val('');
    $('#room_pop_img').attr('src', '');
    $('.room_pop_facility_wrap input').prop(false);
  ...
  /* 객실 사진 등록 */
  $('#room_pop_img_btn').on('click', function () {
    $('#room_img_input').click();
  });

  /* 미리보기 */
  $('#room_img_input').change(function () {
    roomImg(this, '#room_pop_img');
  });
