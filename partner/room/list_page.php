      ...
      <div class="cont">
        ...
        <div class="pager_wrap">
          <p class="pager">
            ...
            if($page <= 1){
            ?>
            <a href="list_page.php?page=1" class="page_prev indent">이전</a>
            <?php } else{ ?>
            <a href="list_page.php?page=<?php echo ($page - 1); ?>" class="page_prev indent">이전</a>
            <?php }; ?>
            ...
            if($page >= $total_page){
            ?>
            <a href="list_page.php?page=<?php echo $total_page; ?>" class="page_next indent">다음</a>
            <?php } else{ ?>
            <a href="list_page.php?page=<?php echo ($page + 1); ?>" class="page_next indent">다음</a>
            <?php }; ?>
          </p>
        </div>
      </div>
